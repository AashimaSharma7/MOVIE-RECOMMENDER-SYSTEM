...
export default function Search({
  ...
  const handleRecommendation = async (e) => {
    ...
    try {
      ...
      // Set progress to 100 after completing the API call
      setProgress(100);
        ...
        <Autocomplete
          ...
          sx={{
            ...
            "& label": {
              ...
              color: (theme) =>
                theme.palette.mode === "dark" ? "dark" : "dark", // Change color when focused
            },
            "& label.Mui-focused": {
              marginTop: "0rem",
              color: (theme) =>
                theme.palette.mode === "dark" ? "grey" : "grey", // Change color when focused
            },
          }}
          open={open}
          onOpen={() => {
          ...
          renderInput={(params) => (
            <TextField
              ...
              sx={{ backgroundColor: "#fff", borderRadius: "25px", width: 500 }}
              InputProps={{
                ...params.InputProps,
                endAdornment: (
                  <React.Fragment>
        ...
        <ThemeProvider theme={customTheme}>
          <Fab
            ...
            sx={{
              ...
              fontWeight: "bold",
              fontSize: "1rem",
              backgroundColor: buttonDisabled && "#fff",
            }}
            aria-label="search"
            variant="extended"
          ...
          >
            Get Rec
            <LocationSearchingIcon fontSize="medium" sx={{ color: "#fff" }} />
            mmendations
          </Fab>
        </ThemeProvider>
        <Snackbar
